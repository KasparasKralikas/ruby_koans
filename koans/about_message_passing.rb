...
class AboutMessagePassing < Neo::Koan
  ...
  def test_sending_undefined_messages_to_a_typical_object_results_in_errors
    ...
    assert_match(/undefined method `foobar' for #<AboutMessagePassing::TypicalObject:(\w*)>/, exception.message)
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    assert_match(/private method `method_missing' called for #<AboutMessagePassing::TypicalObject:(\w*)>/, exception.message)
